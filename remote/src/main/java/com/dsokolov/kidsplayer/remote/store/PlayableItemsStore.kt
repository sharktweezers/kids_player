...
class PlayableItemsStore @Inject constructor() {
    ...
    private val currentItem = MutableStateFlow<Int?>(null)
    ...
    fun updateCurrentItem(currentItemValue: Int?) {
        currentItem.update { currentItemValue }
    }

    fun getCurrentItemFlow() = currentItem.asStateFlow()

    fun updateCurrentPage(currentPageValue: Int) {
        currentPage.update { currentPageValue }
    }

    fun getCurrentPageNumberFlow() = currentPage.asStateFlow()
}